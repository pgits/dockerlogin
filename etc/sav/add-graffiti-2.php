...
function post_graffiti2($sqlInstance, $graffiti_author, $graffitiMessage, $city_Id, $country_code, $envelope_Id, $x, $y, $z, $metersVisible, $now, $until){
	if($sqlInstance != NULL) {
		$arrayResults = array();
		$graffiti_message_id = $sqlInstance->postGraffitiMessage2($graffiti_author, $graffitiMessage, $city_Id, $country_code, $envelope_Id, $x, $y, $z, $metersVisible, $now, $until);
...
#post_graffiti($sqlInstance, $graffiti_author, $graffitiMessage, $country_code, $envelope_Id, $x, $y, NULL, $metersVisible, $date, $until);
