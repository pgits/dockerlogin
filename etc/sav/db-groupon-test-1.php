...
class SqlUtils {
	...
	public function __construct($hostname, $user, $pass, $database){
		...
		$this->sqlGetAuthorId = "SELECT graffiti_author_Id, city_Id FROM " . $database . "." . $this->authorTable . " WHERE ";
...
/* added on 02/26/2017*/
			echo("<graffiti_cityId>" . $city_Id . "</graffiti_cityId>\n");
			return true;	
		}
		else
...
/* added on 02/26/2017*/
				$graffiti_cityId   = $newArray['city_Id'];
				echo("<graffiti_cityId>" . $graffiti_cityId . "</graffiti_cityId>\n");
				$bFoundId = true;
				return true;
			}
			if($bFoundId == false)
...
class graffitiMessageInstance {
	...
	public function __toString(){
		...
		if($this->category != NULL)
	        $outString .= "\t <category>" . 	 	$this->category . 			"</category>\n";
